    ...
    <div class="pt-24 pb-16 px-4 min-h-screen bg-slate-50">
        <div class="max-w-6xl mx-auto">
            ...
            <RouterLink to="/category"
                class="inline-flex items-center gap-2 text-slate-500 font-bold hover:text-teal-600 mb-8 transition group">
                <div
                    class="bg-white p-2 rounded-xl shadow-sm border border-slate-100 group-hover:bg-teal-50 group-hover:border-teal-100 transition">
            ...
            <div v-if="!pet" class="text-center py-20 bg-white rounded-[2rem] border-2 border-dashed border-slate-200">
                ...
                <p class="text-slate-500 mb-6">Có vẻ như giống thú cưng này không tồn tại trong dữ liệu của chúng tôi.
                </p>
                <RouterLink to="/category"
                    class="px-6 py-3 bg-teal-600 text-white font-bold rounded-xl hover:bg-teal-700">
                    ...
                    <div class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="bg-slate-50 p-4 rounded-2xl">
                                ...
                                <div class="flex gap-1">
                                    <span v-for="i in 5" :key="i" class="h-2 w-full rounded-full"
                                        :class="i <= pet.scores?.energy ? 'bg-teal-500' : 'bg-slate-200'"></span>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-50 p-4 rounded-2xl">
                                ...
                                <div class="flex gap-1">
                                    <span v-for="i in 5" :key="i" class="h-2 w-full rounded-full"
                                        :class="i <= pet.scores?.space ? 'bg-blue-500' : 'bg-slate-200'"></span>
                                </div>
                            </div>
                            ...
                            <div class="bg-slate-50 p-4 rounded-2xl">
                                ...
                                <div class="flex gap-1">
                                    <span v-for="i in 5" :key="i" class="h-2 w-full rounded-full"
                                        :class="i <= pet.scores?.grooming ? 'bg-purple-500' : 'bg-slate-200'"></span>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-7 space-y-8">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4 text-slate-500 font-bold text-lg">
                            <span
                                class="flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-slate-100 shadow-sm">
                    ...
                    <!-- Pricing Card -->
                    <div
                        class="bg-gradient-to-br from-teal-600 to-teal-800 rounded-3xl p-8 text-white shadow-xl shadow-teal-900/20 relative overflow-hidden">
                        <div
                        ...
                        <div class="space-y-4 relative z-10">
                            <div
                                class="flex flex-col md:flex-row md:items-center justify-between bg-white/10 p-4 rounded-2xl border border-white/10">
                                <span class="text-teal-100 font-medium mb-1 md:mb-0">Có giấy tờ (VKA)</span>
                                <span class="text-2xl font-black">{{ pet.price.paper }}</span>
                            </div>
                            <div
                                class="flex flex-col md:flex-row md:items-center justify-between bg-white/5 p-4 rounded-2xl border border-white/5">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-slate-600">Liên hệ với chúng tôi để được tư vấn chi tiết về cách nuôi và chăm
                                sóc.</p>
                        </div>
                        <button
